...
public class ColisionCheck {
	...
	public void checkTile(Entity entity) {
		...
		case "up":
			...
			break;
		case "down":
			entityBottomRow = (entityTopWorldY + entity.speed)/gp.titleSize;
	...
	public int checkEntity(Entity entity,Entity[] targate) {
		int index = 999;
		
		for (int i=0; i<targate.length; i++) {
			if(targate[i]!= null) {
				//Get entitys solid area
				entity.solidArea.x = entity.worldX + entity.solidArea.x;
				entity.solidArea.y= entity.worldY + entity.solidArea.y;
				...
				targate[i].solidArea.x = targate[i].worldX + targate[i].solidArea.x;
				targate[i].solidArea.y = targate[i].worldY +targate[i].solidArea.y;
				...
				if (entity.solidArea.intersects(targate[i].solidArea)) {
					if(targate[i] != entity) {
						entity.collisionOn= true;
						index = i ;
					}
				...
				entity.solidArea.x=entity.solidAreaDefaultX;
				entity.solidArea.y=entity.solidAreaDefaultY;
				targate[i].solidArea.x = targate[i].solidAreaDefaultX;
				targate[i].solidArea.y = targate[i].solidAreaDefaultY;
